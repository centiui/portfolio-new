...
<main>
    <div class="snap">
                ...
                <div class="row">
                    ...
                    <div class="col-xl-7 ">
                        <div class="portfolio-padd">
                            ...
                            <h4 class="pricing-desc hiddenup">$150</h4>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="col-md-12">
                            <div class="card mt-4 hidden">
                                <div class="card-body text-center">
                                    ...
                                    <a href="https://discordapp.com/users/1042936842275786865" class="contactbtn btn text-primary btn-lg mt-3 mb-5"><i class="fa-brands fa-discord fa-2xl"></i></a>
        ...
        <section class="snap-section" id="footer">
            <div class="container">
                <div class="row d-flex justify-content-center">
                    <div class="col-xl-4">
                        <ul class="footerul ">
                            <li>
                                <img src="/assets/img/mainlogo.png" width="60%" alt="">
                            </li>
                            <li>
                                <a href="#home">Home</a>
                            </li>
                    ...
                    <div class="col-xl-4">
                        <ul class="footerul ms-auto">
                            <li class="text-white">
                               "CentiUI | Unleashing the power of technology through custom web development and stunning UI/UX design."
                            </li>

                            <li>
                                <a href="https://instagram.com/centiui" class="btn btn-secondary mt-3">Get a Quote</a>
                            </li>
                        </ul>
                    </div>
                </div>
